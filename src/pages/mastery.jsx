...
const Mastery = () => {
  return (
    <div className="max-w-3xl rounded-lg p-8">
      ...
      <p className="prose-xl">
        <strong>
          Goal is to to master the 5 pillars of life. No one in documented
          history has done it.
        </strong>
      </p>
      <br></br>
      ...
      <p className="prose-xl">
        ...
        <div>
          ...
          energy, I think of Stephen A Smith's sass, I think of Shah Rukh Khan
          in his movies, I think of Keegan Michael Key in his skits, I think of
          Maajid Nawaz's speech, I think of Jim Carrey's & Russell Brand's
          comfort in the uncomfortable, I think of Gordon Ramsay's character.
          These are all examples of mastery of charisma in many different forms.
          I would have a great time talking to all of the above people lol.
        </div>
      </p>
      <br></br>
      <p className="prose-xl">
